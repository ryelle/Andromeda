...
module.exports = function(grunt) {
	...
	// Build task.
	grunt.registerTask('dev',     ['sass:dev', 'autoprefixer:dev', 'concat:dev', 'makepot:dev']);
	grunt.registerTask('build',   ['clean:all', 'copy:all', 'sass:dist', 'autoprefixer:dist', 'concat:dist', 'makepot:dist', 'clean:dist']);
